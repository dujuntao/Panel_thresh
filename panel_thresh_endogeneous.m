...
% Data %
%function ivtarpanel;
% load Industrial_transformed_data.txt;
% z=Industrial_transformed_data;
% load Industrial_instrumentsall.txt;
% p=IndustrialDevelop_instrumentsall;

load Industrial_transformed_data.txt;
z=Industrial_transformed_data;
load Industrial_instrumentsall.txt;
p=Industrial_instrumentsall;
